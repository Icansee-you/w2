"""
Django settings for news aggregation project.
"""
import os
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.web.context_processors.error_banner',
            ],
        },
    },
]
...
if os.getenv('DATABASE_URL'):
    try:
        ...
        # dj_database_url not installed, skip
        pass
...
CELERY_BEAT_SCHEDULE = {
    'fetch-nos-feed-every-8-hours': {
        'task': 'apps.feed_ingest.tasks.fetch_nos_feed',
...
# Legacy single feed URL (for backward compatibility)
NOS_RSS_FEED_URL = NOS_RSS_FEEDS[0]

# Login/Logout URLs
LOGIN_URL = 'accounts:login'
LOGIN_REDIRECT_URL = 'news:my_news'
